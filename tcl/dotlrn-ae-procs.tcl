ad_library {
    ...
    Procs to set up the dotLRN ae applet
...
ad_proc -public dotlrn_ae::applet_key {} {
    What's my applet key?
} {
    return dotlrn_ae
}

ad_proc -public dotlrn_ae::package_key {} {
    What package do I deal with?
} {
    return "anon-eval"
}

ad_proc -public dotlrn_ae::my_package_key {} {
    What package do I deal with?
} {
    return "dotlrn-ae"
}

ad_proc -public dotlrn_ae::get_pretty_name {} {
    returns the pretty name
} {
    return "#anon-eval.Applet#"
}

ad_proc -public dotlrn_ae::add_applet {} {
    One time init - must be repeatable!
} {
    dotlrn_applet::add_applet_to_dotlrn -applet_key [applet_key] -package_key [my_package_key]
}

ad_proc -public dotlrn_ae::remove_applet {} {
    One time destroy. 
} {
...
ad_proc -public dotlrn_ae::add_applet_to_community {
    community_id
} {
    Add the ae applet to a specific dotlrn community
} {
    set portal_id [dotlrn_community::get_portal_id -community_id $community_id]

    # create the ae package instance 
    ...
    ae_admin_portlet::add_self_to_page \
...
ad_proc -public dotlrn_ae::remove_applet_from_community {
    community_id
} {
...
ad_proc -public dotlrn_ae::add_user {
    user_id
} {
...
ad_proc -public dotlrn_ae::remove_user {
    user_id
} {
} {
...
ad_proc -public dotlrn_ae::add_user_to_community {
    community_id
    user_id
} {
...
ad_proc -public dotlrn_ae::remove_user_from_community {
    community_id
    user_id
} {
...
ad_proc -public dotlrn_ae::add_portlet {
    portal_id
} {
...
ad_proc -public dotlrn_ae::add_portlet_helper {
    portal_id
    args
} {
    A helper proc to add the underlying portlet to the given portal.
    ...
    ae_portlet::add_self_to_page \
        -portal_id $portal_id \
        -package_id [ns_set get $args package_id] \
        -param_action [ns_set get $args param_action]
}

ad_proc -public dotlrn_ae::remove_portlet {
    portal_id
    args
} {
    ...
    ae_portlet::remove_self_from_page \
        -portal_id $portal_id \
        -package_id [ns_set get $args package_id]
}

ad_proc -public dotlrn_ae::clone {
    old_community_id
    new_community_id
} {
	...
	dotlrn_ae::assessment_copy -assessment_id [lindex $assessment 0] -name [lindex $assessment 1] -folder_id $folder_id
    }
    return $new_package_id
}

ad_proc -public dotlrn_ae::change_event_handler {
    community_id
    event
    old_value
    new_value
...
ad_proc -public dotlrn_ae::assessment_copy {
